            ...
            then do
              ...
              Prelude.return
                ( Lens.Family2.over
                    ...
                    (\ !t -> Prelude.reverse t)
                    ( Lens.Family2.set
                        (Data.ProtoLens.Field.field @"vec'scopeSpans")
                        frozen'scopeSpans
                        x
                    )
                )
...
data ScopeSpans = ScopeSpans'_constructor
  { _ScopeSpans'scope :: !(Prelude.Maybe Proto.Opentelemetry.Proto.Common.V1.Common.InstrumentationScope)
...
instance Data.ProtoLens.Field.HasField ScopeSpans "scope" Proto.Opentelemetry.Proto.Common.V1.Common.InstrumentationScope where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _ScopeSpans'scope
          (\x__ y__ -> x__ {_ScopeSpans'scope = y__})
      )
      (Data.ProtoLens.maybeLens Data.ProtoLens.defMessage)
...
instance Data.ProtoLens.Field.HasField ScopeSpans "spans" [Span] where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _ScopeSpans'spans
          (\x__ y__ -> x__ {_ScopeSpans'spans = y__})
      )
      ( Lens.Family2.Unchecked.lens
          Data.Vector.Generic.toList
          (\_ y__ -> Data.Vector.Generic.fromList y__)
...
packedFileDescriptor =
  ...
  \w\n\
  \\ACK\EOT\EOT\EOT\NUL\STX\SOH\DC2\EOT\144\STX\EOT(\SUBg The Span has been validated by an Application developer or Operator to \n\
