...
import Proto.Opentelemetry.Proto.Metrics.V1.Metrics qualified
...
data ExportMetricsPartialSuccess = ExportMetricsPartialSuccess'_constructor
...
data ExportMetricsServiceResponse = ExportMetricsServiceResponse'_constructor
              ...
              case tag of
                10 ->
                  do
                    ...
                    loop
                      ( Lens.Family2.set
                          (Data.ProtoLens.Field.field @"partialSuccess")
                          y
                          x
                      )
                wire ->
